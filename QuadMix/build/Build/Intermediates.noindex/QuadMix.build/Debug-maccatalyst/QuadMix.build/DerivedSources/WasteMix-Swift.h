...
#ifndef WASTEMIX_SWIFT_H
#define WASTEMIX_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WasteMix",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8WasteMix12CameraSource")
...
@interface CameraSource (SWIFT_EXTENSION(WasteMix)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class MTKView;
SWIFT_CLASS("_TtC8WasteMix12RenderEngine")
@interface RenderEngine : NSObject <MTKViewDelegate>
...
SWIFT_CLASS("_TtC8WasteMix19WasteMixAppDelegate")
@interface WasteMixAppDelegate : NSObject <UIApplicationDelegate>
